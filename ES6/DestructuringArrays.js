...
(() => {
  "use strict";
    ...
    //Using destructuring assignment to swap the values of 
    //carDoor1 and carDoor2 so that carDoor1 receives the value stored in carDoor2, and carDoor2 receives the value stored in carDoor1.
